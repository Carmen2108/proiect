...
$ReadSql = "SELECT * FROM `autographs`";
...
<header>
    ...
    <main>
        <section class="main-template">
            <div class="my-body">
                <h1 style="color:#27a29e;font-family: 'Open Sans' ;font-weight: bold;text-align:center; padding-top:5%;">
                    Welcome, <b><?php 
			    echo $_SESSION['username'];
        	    ?></b> ! Here is a list with all our autographs</h1>
                <div class="search">
